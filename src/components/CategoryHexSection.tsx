...
import { ProductCategory, PageSection } from '../types';
          ...
          {CATEGORIES_DATA.map((cat) => {
            ...
            return (
              <div
                ...
                className="group cursor-pointer bg-white rounded-2xl p-6 border border-slate-200 hover:border-amber-400 hover:shadow-xl transition-all duration-300 flex flex-col justify-between relative overflow-hidden"
              >
